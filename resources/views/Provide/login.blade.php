...
<html lang="en">
  ...
  <body style="background: url('eggsbook/img/casino-background.jpg')!important">
    ...
    <div class="wrapper-page wrapper-page-form">
      <div class="panel panel-color panel-primary panel-pages gradient-border">
        <div class="panel-body">
          ...
          <h4 class="text-white text-center m-t-0" style="color:black!important"><b>Sign In</b></h4>

          <form class="form-horizontal m-t-20" method="POST" action="{{route('provide.postLogin')}}" >
            @csrf
            ...
            <div class="form-group text-center m-t-20 row ">
              ...
              <button class="btn btn-success w-md waves-effect waves-light btnSubmit"  type="submit" style="background-color: #0501ba !important"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign In</button>
