                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            @if (Session('user')->User_Level == 1)
                                <div class="col-md-4">
                                    <form method="post" action="{{ route('system.admin.postImportGameSA') }}"
                                                        ...
                                                        <div class="form-body">
                                                            <div class="row">
                                                                <div class="form-group">
                                                                    <label for="">Import Total Week Casino Online</label>
                                                                    <input type="file" name="ImportTotalWeek"
                                                                        class="form-control" placeholder="Enter image">
                                                                </div>
                                                                <div class="form-group form-check">
                                                                    <input class="form-check-input" type="radio" name="week" value="this" id="week-this" checked>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="">Import Bet SportBook</label>
                                                                    <input type="file" name="SportBook" class="form-control"
