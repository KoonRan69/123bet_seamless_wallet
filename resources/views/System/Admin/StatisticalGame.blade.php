                                                            ...
                                                            <div class="form-group">
                                                                <div class="form-actions mt-10">
                                                                    ...
                                                                    <button type="submit"
                                                                        ...
                                                                        class="btn-filler btn btn-success  mr-10"><i
                                                                            class="fa fa-file-excel-o"
                                                                            aria-hidden="true"></i> Export one page</button>
                                                                    @endif
                                                                    <a href="{{ route('system.admin.getStatisticalGame') }}"
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;" class="border-right"></th>
                                                          	<th class=""style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;"></th>
                                                            <th style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;" class="border-right"></th>
                                                          	<th colspan="4" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;" class="border-right">Game</th>
                                                              <th rowspan="4" class=""
                                                                style="text-align: center;vertical-align: middle; border: 1px solid;background: linear-gradient(to top, #f5b61a, #f58345)!important;">
                                                                Date
                                                        </th>
                                                        ...
                                                        <tr>
		                                                    ...
		                                                    <th colspan="2" class="text-right border-right" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;">Balance</th>
                                                          	<th colspan="2" class="text-right border-right" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;">Deposit battle game</th>
                                                          	<th colspan="2" class="text-right border-right" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;">Withdraw battle game</th>
                                                          	<th colspan="2" class="text-right border-right" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;">EUSD</th>
                                                          	<th colspan="2" class="text-right border-right" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;">Gold</th>
                                                        </tr>
                                                        <tr>
                                                            <!-- 							balance -->
		                                                    ...
		                                                    <th class="text-right" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;">GOLD</th>
                                                          	<th class="text-right" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;">EUSD</th>
		                                                    <th class="text-right" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;">GOLD</th>
                                                          	<th class="text-right" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;">Win</th>
		                                                    <th class="text-right" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;">Lose</th>
                                                          	<th class="text-right" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;">Win</th>
		                                                    <th class="text-right" style="text-align: center;vertical-align: middle; border: 1px solid; background: #FABF8F !important;">Lose</th>
                                                        </tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>{{$value->UserID}}</td>
                                                            <td class="text-right">{{ $value->balance_eusd ?? 0 }}</td>
                                                            <td class="text-right">{{ $value->balance_gold ?? 0 }}</td>
                                                            <td class="text-right">{{-$value->deposit_battle_game_eusd ?? 0}}</td>
                                                            <td class="text-right">{{-$value->deposit_battle_game_gold ?? 0}}</td>
                                                            <td class="text-right">{{$value->withdraw_battle_game_eusd ?? 0}}</td>
                                                            <td class="text-right">{{$value->withdraw_battle_game_gold ?? 0}}</td>
                                                            <td class="text-right">{{$value->total_win_eusd}}</td>
                                                            <td class="text-right">{{$value->total_lose_eusd}}</td>
                                                            <td class="text-right">{{$value->total_win_gold}}</td>
                                                            <td class="text-right">{{$value->total_lose_gold}}</td>
                                                            <td class="text-right">{{$value->statistical_Time}}</td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
