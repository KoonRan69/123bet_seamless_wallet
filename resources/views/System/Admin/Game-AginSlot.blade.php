      ...
      <div class="col-md-12">
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <form method="post" action="{{route('system.admin.postImportGameAginSlot')}}"
                        ...
                        <div class="form-body">
                          <div class="row">
                            <div class="form-group">
                              <label for="">Import Total Week Agin Slot</label>
            ...
            <div class="col-md-8 mx-auto">
              <form method="GET" action="{{route('system.admin.getAginSlot')}}">
                @csrf
