        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Pools</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="javascript:void(0);">EGGS</a></li>
                        <li class="active" style="color:#fff">Pools</li>
                    </ol>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label mb-10"
                                                                    for="exampleInputpwd_1"><i class="fa fa-users"
                                                                        aria-hidden="true"></i> POOL ID</label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="POOL ID" name="pool_id"
                                                                    value="{{request()->input('pool_id')}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <div class="form-actions mt-10">
                                                                    ...
                                                                    @endif
                                                                    <a href="{{ route('system.admin.getHistoryPools') }}"
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $pl->Owner }}</td>
                                                            <td>{{ $pl->Skin }}</td>
                                                            <td>{{ $pl->poolType->Name }}</td>
                                                            <td>{{ date('d-m-Y H:i:s', intval(strval($pl->CreateAt))/1000) }}</td>
                                                        </tr>
                                                        @endforeach

                                                    </tbody>
	                                                {{$pools->appends(request()->input())->links('System.Layouts.Pagination')}}
                                                </table>
                                            </div>
                                        </div>
                                    </div>
    ...
    $(function() {
                $('#exportTest').click(function(){
                    $(".demo-foo-col-exp").table2excel({
                        exclude: ".noExl",
                        name: "Pools",
                        filename: "Pools" + new Date().toISOString().replace(/[\-\:\.]/g, "")+".xls",
                        fileext: ".xls",
                        exclude_img: true,
                        exclude_links: true,
                        exclude_inputs: true
