                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label mb-10"
                                                                    for="exampleInputpwd_1"><i class="fa fa-users"
                                                                        aria-hidden="true"></i> FISHS ID</label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="FISHS ID" name="fishs_id"
                                                                    value="{{request()->input('fishs_id')}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <div class="form-actions mt-10">
                                                                    ...
                                                                    @endif
                                                                    <a href="{{ route('system.admin.getHistoryFishs') }}"
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $fi->Pool }}</td>
                                                            <td>{{ $fi->From }}</td>
                                                            <td>{{ date('d-m-Y H:i:s', $fi->Born) }}</td>
                                                            <td>{{ date('d-m-Y H:i:s', $fi->ActiveTime + $fi->GrowTime) }}</td>
                                                            <td>{{ $fi->ActiveTime? date('d-m-Y H:i:s', $fi->ActiveTime): 0 }}</td>
                                                            <td>{{ $fi->fishTypes->Name }}</td>
                                                            <td>{{ $fi->F }}</td>
                                                            <td>{{$fi->Status == 1? 'Current': ($fi->Status == -1? 'Die because of hungry': 'Die because of over life cycle')}}</td>
                                                        </tr>
                                                        @endforeach

                                                    </tbody>
                                                     {{$fishs->appends(request()->input())->links('System.Layouts.Pagination')}}
                                                </table>
                                            </div>
                                        </div>
                                    </div>
