...
@section('title', 'Admin-Game-Evolution')
@section('css')
      ...
      <div class="col-md-12">
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <form method="post" action="{{route('system.admin.postImportVolumeEvolutions')}}"
                        ...
                        <div class="form-body">
                          <div class="row">
                            <div class="form-group">
                              <label for="">Import Total Week Evolution</label>
                              <input type="file" name="ImportTotalWeekEvolution"
            ...
            <div class="col-md-8 mx-auto">
              <form method="GET" action="{{route('system.admin.getHistoryEvolutions')}}">
                @csrf
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                  <select type="text" class="form-control"
                                          name="type_date">
                                    <option value="week"
                                            {{ request()->input('type_date') && request()->input('type_date') == 'week' ? 'selected' : '' }}> Week </option>
                                    <option value="day"
                                            {{ request()->input('type_date') && request()->input('type_date') == 'day' ? 'selected' : '' }}> Day </option>
                                  </select>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-6">
                              <div class="form-group">
                                <div class="form-actions mt-10">
                                  ...
                                  <a href="{{ route('system.admin.getHistoryEvolutions') }}"
