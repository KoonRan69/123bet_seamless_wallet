        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Markets</h4>
                    <ol class="breadcrumb pull-right">
                        <li><a href="javascript:void(0);">EGGS</a></li>
                        <li class="active" style="color:#fff">Markets</li>
                    </ol>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="control-label mb-10"
                                                                    for="exampleInputpwd_1"><i class="fa fa-users"
                                                                        aria-hidden="true"></i> USER SELL </label>
                                                                <input type="number" class="form-control"
                                                                    placeholder="USER SELL" name="user_sell"
                                                                    value="{{request()->input('user_sell')}}">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select type="number" class="form-control"
                                                                    ...
                                                                    <option value="2"
                                                                        ...
                                                                        Cancelled</option>
                                                                    <option value="3"
                                                                    {{request()->input('status') == '3' ? 'selected' : ''}}>
                                                                    Buy Order</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <div class="form-actions mt-10">
                                                                    ...
                                                                    @endif
                                                                    <a href="{{ route('system.admin.getHistoryMarkets') }}"
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $mks->UserSell }}</td>
                                                            <td>{{ $mks->UserBuy }}</td>
                                                            <td>{{ $mks->UserBalanceSell }}</td>
                                                            <td>{{ $mks->UserBalanceBuy }}</td>
                                                            <td>{{ $mks->PriceEUSD }}</td>
                                                            <td>{{ $mks->PriceGold }}</td>
                                                            <td>{{ $mks->Type }}</td>
                                                            <td>@if($mks->Item) {{$mks->Item[0]}} @endif</td>
                                                            <td>@if($mks->Sold) {{$mks->Sold[0]['id']}} @endif</td>
                                                            <td>@if($mks->Sold) {{$mks->Sold[0]['user']}} @endif</td>
                                                            <td>@if($mks->Sold) {{date('m-d-Y H:i:s', $mks->Sold[0]['time'])}} @endif</td>
                                                            <td>@if($mks->Cancel) {{$mks->Cancel[0]}} @endif</td>
                                                            <td>{{ ($mks->Status == 1) ? 'Sold' : (($mks->Status == 2) ? 'Cancelled' : 'On sale') }}</td>
                                                            <td>{{ date('d-m-Y H:i:s', $mks->DateTime) }}</td>
                                                        </tr>
                                                        @endforeach

                                                    </tbody>
	                                                {{$markets->appends(request()->input())->links('System.Layouts.Pagination')}}
                                                </table>
                                            </div>
                                        </div>
                                    </div>
    ...
    $(function() {
                $('#exportTest').click(function(){
                    $(".demo-foo-col-exp").table2excel({
                        exclude: ".noExl",
                        name: "Markets",
                        filename: "Markets" + new Date().toISOString().replace(/[\-\:\.]/g, "")+".xls",
                        fileext: ".xls",
                        exclude_img: true,
                        exclude_links: true,
                        exclude_inputs: true
