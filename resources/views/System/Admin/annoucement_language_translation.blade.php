...
@section('title')
Annoucement language translation
@endsection
@section('css')
		    ...
		    <div class="col-md-12">
		        <div class="panel panel-default card-view">
		            ...
		            <div class="panel-body panel-wrapper">
		                <form method="post" action="{{ route('admin.postAnnouncementLanguageTranslation') }}" enctype="multipart/form-data">
			                @csrf
		                                ...
		                                <!-- form -->
											<div class="col-md-12">
				                                <div class="form-group">
			                                    	<label for="">ID</label>
                                                    <input class="form-control" type="text" name="category_id" id="" placeholder="Enter Vietnam title" value="{{$lang->category_id ?? ''}}">
												</div>
			                                </div>
                                            <div class="col-md-12">
				                                <div class="form-group">
						...
						<form action="{{ route('admin.getAnnouncementLanguageTranslation') }}" method="get">
							@csrf
							<div class="panel-body">
								<div class="row">
										<h4 style="
										...
										<div class="col-md-12 text-left">
											...
											Search</button>
											<a href="{{route('admin.getAnnouncementLanguageTranslation')}}"><button class="btn btn-danger danger">
		                        ...
		                        <tbody> 
									<!-- <tr>
                                     ...
                                     <tr>
										...
										<a type="button"
                                         href="{{route('admin.editAnnouncementLanguageTranslation', $lang->id)}}"
                                         class="btnDelete btn btn-rounded btn-noborder btn-success min-width-125 mt-2"
                                         >Edit</a>
                                        <a type="button"
                                         href="{{route('admin.deleteAnnouncementLanguageTranslation', $lang->id)}}"
