      ...
      <div class="col-md-12">
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <form method="post" action="{{ route('system.admin.postImportGameAeSexy') }}"
                        ...
                        <div class="form-body">
                          <div class="row">
                            <div class="form-group">
                              <label for="">Import Total Week Ae Sexy</label>
                              <input type="file" name="ImportTotalWeekAesexy"
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                <div class="form-actions mt-10">
                                  ...
                                  <a href="{{ route('system.admin.getAeSexy') }}"
