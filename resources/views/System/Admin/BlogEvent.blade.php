    ...
    <div class="container-fluid">
		    ...
		    <div class="col-md-12">
		        <div class="panel panel-default card-view">
		            <div class="panel-heading">
			            <h4 class="panel-title text-left">Add new Blog</h4>
		            </div>
		                                ...
		                                <!-- form -->
			                                <div class="col-md-12 col-lg-12">
				                                <div class="form-group">
													...
													{{-- <input id="banner" type="file" name="banner" class="form-control" placeholder="Enter image"> --}}
												</div>
			                                </div>
			                                <div class="col-md-6 col-lg-6">
				                                <div class="form-group">
			                                    	<label for="">Title</label>
					                                <input id="title" type="name" name="title" class="form-control" placeholder="Enter User ID">
				                                </div>
			                                </div>
			                                <div class="col-md-6 col-lg-6">
				                                <div class="form-group">
			                                    	<label for="">Description</label>
					                                <input id="description" type="name" name="description" class="form-control" placeholder="Enter User ID">
				                                </div>
			                                </div>
			                                <div class="col-md-6 col-lg-12">
				                                <div class="form-group">
					                                ...
					                                <textarea id="content" class="summernote-editor" name="content"> Enter description</textarea>
				                                </div>
			                                </div>
		...
		<div class="row">
		    <div class="col-xl-12">
		        <div class="panel panel-default card-view">
		            <div class="panel-heading">
			            <h4 class="panel-title text-left">List Blog</h4>
		            </div>
		            <div class="panel-body">
...
<script>
  ...
  $("#add_blog").on('submit', function(event){
    ...
    $.ajax({
      url : "{{route('system.admin.postAddBlog')}}",
      type : "POST", 
      data:formData,
      cache:false,
      contentType: false,
