        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-8 mx-auto">
              <form method="GET" action="{{route('system.admin.getBalancePlayer')}}">
                @csrf
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="User_Name_Sbobet" class="form-control"
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                <div class="form-actions mt-10">
                                  ...
                                  <a href="{{ route('system.admin.getBalancePlayer') }}"
