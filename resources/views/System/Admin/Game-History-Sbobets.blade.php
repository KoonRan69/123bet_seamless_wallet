...
@section('title', 'Admin-Game-Sbobets')
@section('css')
      ...
      <div class="col-md-12">
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <form method="post" action="{{route('system.admin.postImportVolumeSbobets')}}"
                        ...
                        <div class="form-body">
                          <div class="row">
                            <div class="form-group">
                              <label for="">Import Total Week Sbobet</label>
                              <input type="file" name="ImportThisWeelSbobet"
            ...
            <div class="col-md-8 mx-auto">
              <form method="GET" action="{{route('system.admin.getHistorySbobets')}}">
                @csrf
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                <div class="form-actions mt-10">
                                  ...
                                  <a href="{{ route('system.admin.getHistorySbobets') }}"
