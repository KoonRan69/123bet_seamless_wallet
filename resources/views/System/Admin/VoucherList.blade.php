                        ...
                        <div class="form-body">
                          <div class="row">
                            ...
                            <div class="form-group col-span-2 lg:col-span-1 flex flex-col ">
                              ...
                              <input class="form-control" type="text" placeholder="" value="{{request()->input('amountfrom')}}" name="amountfrom">
                            </div>
                            <div class="form-group col-span-2 lg:col-span-1 flex flex-col ">
                              <label for="">Amoun To</label>
                              <input class="form-control" type="text" placeholder="" value="{{request()->input('amounto')}}" name="amounto">
                            </div>
                            <div class="form-group col-span-2 lg:col-span-1 flex flex-col ">
                              ...
                              <select  name="type" class="form-control" id="">
                                <option selected value="" class="text-black"
                                  ...
                                  --- Select ---</option>
                                <option value="1" class="text-black"
                                        {{request()->input('type') == 1 ? 'selected' : ''}}>
                                  Item</option>
                                <option value="money" class="text-black"
                                        {{request()->input('type') == 'money' ? 'selected' : ''}}>
                                  Money</option>
                        ...
                        <table id="member-list"
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>{{number_format($v->amount, 4)}}</td>
                              <td>
                                <span class="badge badge-{{$v->type == 1 ? 'success' : 'info'}}">
                                  {{$v->type == 1 ? 'Item' : 'Money'}}
                                </span>
                              </td>
                              <td>{{$v->created_at}}</td>
