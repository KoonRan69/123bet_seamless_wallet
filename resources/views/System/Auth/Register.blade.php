        ...
        <div class="wrapper-page wrapper-page-form">
            <div class="panel panel-color panel-primary panel-pages bg-form">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal m-t-20" method="post" action="{{ route('postRegister') }}">
                        @csrf
                        <!-- <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" name="name" type="text" required="" placeholder="User Name" value="{{old('name')}}">
                            </div>
                        </div> -->
                        <div class="form-group">
                            <div class="col-xs-12">
                        ...
                        {{-- <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" name="full_name" type="text" required="" placeholder="Full Name" value="{{old('full_name')}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" name="phone" type="number" required="" placeholder="Phone Number" value="{{old('phone')}}">
                            </div>
                        </div> --}}
                        <div class="form-group">
                            <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" name="password_comfirm" type="password" required="" placeholder="Password Confirm">
                            </div>
                        </div>
						<!--<div class="form-group">
                            <div class="col-xs-12">
								<div class="form-check">
									<input class="form-check-input" type="radio" value="1" name="master" id="master1">
									<label class="form-check-label txt-light" for="master1">
										Master 1
									</label>
								</div>
								<div class="form-check">
									<input class="form-check-input" type="radio" value="2" name="master" id="master2">
									<label class="form-check-label txt-light" for="master2">
										Master 2
									</label>
								</div>
								<div class="form-check">
									<input class="form-check-input" type="radio" value="3" name="master" id="master3">
									<label class="form-check-label txt-light" for="master3">
										Master 3
									</label>
								</div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                            <input class="form-control" value="{{  $parent }}" name="sponser" type="text" placeholder="Sponsor">
                            </div>
                        </div>

                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btn-lucky w-md waves-effect waves-light" type="submit">Sign Up</button>
                            </div>
                        </div>
					<input type="hidden" name="telegram" value="{{request()->input('telegram')}}">
                        <div class="form-group m-t-30 m-b-0">
                            <div class="col-sm-12 text-center">
                                <a href="{{ route('getLogin') }}" class="text-white">Already have account?</a>
                            </div>
                        </div>
