    ...
    <div class="wrapper-page wrapper-page-form">
      <div class="panel panel-color panel-primary panel-pages gradient-border">
        <div class="panel-body">
          ...
          <form class="form-horizontal m-t-20" method="POST" action="{{route('postLoginSbobet')}}" >
            @csrf
            <input class="form-control" name="redirect" type="hidden" value="{{request()->input('redirect')}}">
            <div class="form-group">
              <div class="col-xs-12">
                <label class="control-label mb-10"
                       for="exampleInputpwd_1"> Type Game</label>
                <select id="typegame" class="form-control"
                        name="typegame">
                  <option value="Games">Games Lobby</option>
                  <option value="SportsBook">SportsBook</option>
                  <option value="Evolution">Evolution</option>
                  <option value="Casino">Casino</option>
                  <option value="VirtualSports">VirtualSports</option>
                  <option value="SeamlessGame">SeamlessGame</option>
                  <option value="ThirdPartySportsBook">ThirdPartySportsBook</option>
                  <option value="SboLive">SboLive</option>
                </select>
              </div>
            </div>
            <div class="form-group">
