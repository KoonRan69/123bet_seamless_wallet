...
use DB;
class AginSportLastWeek implements ToCollection, WithHeadingRow
{
  /**
  ...
  public function collection (Collection $rows)
  {
    ...
    $deleteOld = DB::table('bet_history_agin')->where('billtime', '>=', $mondayLastWeek)->where('billtime', '<', $mondayThisWeek)->delete();
