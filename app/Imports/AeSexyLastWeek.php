...
use DB;
class AeSexyLastWeek implements ToCollection, WithHeadingRow
{
  /**
  ...
  public function collection (Collection $rows)
  {
    ...
    $deleteOld = DB::table('bet_history_ae_sexy')->where('time123bet', '>=', $mondayLastWeek)->where('time123bet', '<', $mondayThisWeek)->delete();
